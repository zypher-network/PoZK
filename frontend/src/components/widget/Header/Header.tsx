...
import UserAvatar from '@/components/icon/user-avatar.svg';
  ...
  return (
    <div className="flex items-center justify-between min-h-[44px] mt-[44px] mb-[40px]">
      ...
      {hasToken && isConnected ? (
        <div className="cursor-pointer flex justify-center items-center rounded-full" onClick={() => open({ view: 'Account' })}>
